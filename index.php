...
<head>
    ...
    <!--FAvicon -->
    <link rel="apple-touch-icon" sizes="180x180" href="/images/apple-touch-icon.png?v=Gv6Og2WOAW">
    <link rel="icon" type="image/png" sizes="32x32" href="/images/favicon-32x32.png?v=Gv6Og2WOAW">
    <link rel="icon" type="image/png" sizes="16x16" href="/images/favicon-16x16.png?v=Gv6Og2WOAW">
    <link rel="manifest" href="/images/site.webmanifest?v=Gv6Og2WOAW">
    <link rel="mask-icon" href="/images/safari-pinned-tab.svg?v=Gv6Og2WOAW" color="#5bbad5">
    <link rel="shortcut icon" href="/images/favicon.ico?v=Gv6Og2WOAW">
    <meta name="msapplication-TileColor" content="#9f00a7">
    <meta name="msapplication-config" content="/images/browserconfig.xml?v=Gv6Og2WOAW">
    ...
    <div class="container d-flex align-items-center">
        ...
        <a class="navbar-brand" href="index.php">
            <picture>
                ...
                <img src="amai_logo.png" alt="Centro de Apoyo a la Maternidad y Alimentación Infantil - Logo"
                     height="60">
            </picture>
        </a>
        ...
        <div class="collapse navbar-collapse" id="nav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item"><a href="https://www.centroamai.cl/#especialistas"
                                        class="nav-link">Especialistas</a></li>
    ...
    <div class="container-wrap">
        <div class="row no-gutters">
            <div class="col-md-3 ftco-animate">
                <a href="https://www.centroamai.cl/images/fotos_amai.jpeg"
                   class="gallery image-popup img d-flex align-items-center" id="foto1">
                </a>
            </div>

            <div class="col-md-3 ftco-animate">
                <a href="https://www.centroamai.cl/images/fotos_portada1.jpeg"
                   class="gallery image-popup img d-flex align-items-center" id="foto2">
                </a>
            </div>
            <div class="col-md-3 ftco-animate">
                <a href="https://www.centroamai.cl/images/amai_logo.jpg"
                   class="gallery image-popup img d-flex align-items-center" id="foto3">
                </a>
            </div>

            <div class="col-md-3 ftco-animate">
                <a href="https://www.centroamai.cl/images/fotos_amai3.jpeg"
                   class="gallery image-popup img d-flex align-items-center" id="foto4">
                </a>
            </div>
            <div class="col-md-3 ftco-animate">
                <a href="https://www.centroamai.cl/images/fotos_portada3.jpeg"
                   class="gallery image-popup img d-flex align-items-center" id="foto5">
                </a>
            </div>
            <div class="col-md-3 ftco-animate">
                <a href="https://www.centroamai.cl/images/fotos_amai4.jpeg"
                   class="gallery image-popup img d-flex align-items-center" id="foto6">
                </a>
            </div>
            <div class="col-md-3 ftco-animate">
                <a href="https://www.centroamai.cl/images/fotos_portada2.jpeg"
                   class="gallery image-popup img d-flex align-items-center" id="foto7">
                </a>
            </div>

            <div class="col-md-3 ftco-animate">
                <a href="https://www.centroamai.cl/images/fotos_amai1.jpeg"
                   class="gallery image-popup img d-flex align-items-center" id="foto8">
                </a>
            </div>
    ...
    <div class="container">
        ...
        <div class="row mb-5">
            ...
            <div class="col-md-6 col-lg-3 ftco-animate">
                <div class="staff">
                    <div class="img-wrap d-flex align-items-stretch">
                        <div class="img align-self-stretch" id="item19">
                        </div>
                    </div>
                    <div class="text pt-3 text-center">
                        <h3>Felipe Contreras</h3>
                        <span class="position">Psicólogo</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-3 ftco-animate">
                <div class="staff">
                    <div class="img-wrap d-flex align-items-stretch">
                        <div class="img align-self-stretch" id="item20">
                        </div>
                    </div>
                    <div class="text pt-3 text-center">
                        <h3>Valentina Collao</h3>
                        <span class="position">Nutricionista</span>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row mb-5 pb-2">
            <div class="col-md-6 text-center heading-section heading-section-black ftco-animate">
                ...
                <h6 class="font-weight-normal px-3" style="color: white;">"Ser el primer y mejor centro integral de
                    apoyo
...
<footer class="ftco-footer ftco-bg-dark ftco-section" id="contacto">
    <div class="container">
            ...
            <div class="col-md-4 col-lg-4">
                <div class="ftco-footer-widget">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="https://www.centroamai.cl/#inicio"><span
                                        class="ion-ios-arrow-round-forward mr-2"></span>Inicio</a>
                        </li>
                        <li><a href="https://www.centroamai.cl/#servicios"><span
                                        class="ion-ios-arrow-round-forward mr-2"></span>Servicios</a>
                        </li>
                        <li>
                            <a href="https://www.centroamai.cl/#especialistas"><span
                                        class="ion-ios-arrow-round-forward mr-2"></span>Especialistas</a>
                        </li>
                        <li><a href="https://www.centroamai.cl/#contacto"><span
                ...
                <div class="ftco-footer-widget">
                    ...
                    <div>
                        <ul class="ftco-footer-social list-unstyled float-md-left float-lft">
                            <li class="ftco-animate"><a href="https://www.facebook.com/centroamai/" target="_blank"
                                                        rel="noopener"><span class="icon-facebook"></span></a></li>
                            <li class="ftco-animate"><a href="https://www.instagram.com/centroamai/" target="_blank"
                                                        rel="noopener"><span class="icon-instagram"></span></a></li>
                        </ul>
                    </div>
        ...
        <div class="row mb-5 d-flex justify-content-center">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1028.1569422444134!2d-71.25612644271442!3d-29.913438628768006!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x9691cbd655a180cb%3A0xe7db50e14c040b93!2sCentro%20Amai!5e0!3m2!1sen!2scl!4v1609260296618!5m2!1sen!2scl"
                    width="1200" height="400" style="border:0;" allowfullscreen="" aria-hidden="false"
                    tabindex="0"></iframe>
        </div>
    </div>
    ...
    <div class="text-center pb-1 ftco-footer-copyright">
        <p class="px-2">Esta plantilla está hecha con <i class="icon-heart" aria-hidden="true"></i> por <a
                    href="https://colorlib.com" target="_blank" rel="noopener"><b>Colorlib</b></a>
