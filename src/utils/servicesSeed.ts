import { FaBaby, FaAppleWhole, FaUserDoctor, FaPuzzlePiece } from 'react-icons/fa6'
...
const navServicesChild: NavService[] = [
  ...
  {
    name: 'Nutrición',
    description: 'Alimentación complementaria, método BLW y alergias alimentarias.',
  },
]
...
const detailServices: Service[] = [
  ...
  },
  {
    icon: FaAppleWhole,
    service: 'Nutrición',
    descriptions: ['Selectividad alimentaria', 'Nutrición vegetariana', 'Atención neurodivergente'],
  },
  {
