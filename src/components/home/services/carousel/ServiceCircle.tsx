...
const ServiceCircle = ({ dotColor }: { dotColor: string }) => {
  return (
    <CarouselItem className="flex basis-1/12 items-center justify-center p-0">
      <svg className="hidden md:block" height="100" width="50" xmlns="http://www.w3.org/2000/svg">
        <circle r="10" cx="25" cy="50" fill={dotColor} />
      </svg>
      <svg className="block md:hidden" height="100" width="50" xmlns="http://www.w3.org/2000/svg">
